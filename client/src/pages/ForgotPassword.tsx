  ...
  return (
    <div className="min-h-screen font-sans selection:bg-fuchsia-500/30 overflow-hidden relative bg-slate-900 text-slate-200 flex items-center justify-center p-4">
      ...
      >
        ...
        <h2 className="text-3xl font-display font-medium text-white mb-2">Reset Password</h2>
        ...
        {submitted ? (
          ...
          <form onSubmit={handleReset} className="space-y-5">
            ...
            <button 
              type="submit" 
              className="w-full py-3.5 mt-4 rounded-xl font-medium text-white bg-rose-500 hover:bg-rose-600 shadow-lg shadow-rose-500/20 transition-all"
            >
              Send Reset Link
            </button>
          </form>
